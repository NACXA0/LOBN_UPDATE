...
class REDIS:  # 用大写防止与redis包重名
    local_redis_url: str = 'redis://localhost:6379' # 本地redis地址
...
class alipay:   # 支付宝相关
    ...
    # APPID 即创建应用后生成
    sandbox_app_id = '9021000140651982'
    # AES秘钥,开放平台接口内容加密方式中获取
    sandbox_encrypt_key = 'SEkZSzgsgIiLj0OllsdSsw=='
    # 支付宝公钥
    sandbox_alipay_public_key = ''
    # 开发者私钥，由开发者自己生成。格式:PKCS1
